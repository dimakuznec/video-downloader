	...
	const translations = {
		...
		ru: {
			...
			steps: [
				...
				'5. Мы рекомендуем скачивать видео в формате WEBM. Если возникают проблемы, попробуйте формат MP4. Это должно помочь воспроизвести видео на вашем компьютере с Windows.',
			],
			buttons: {
		...
		zh: {
			...
			steps: [
				...
				'5. 我们推荐以 WEBM 格式下载视频。如果遇到问题，请尝试 MP4 格式。这有助于在您的 Windows 电脑上播放。',
			],
			buttons: {
				previous: '上一步',
				next: '下一步',
